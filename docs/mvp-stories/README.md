...
| 022. [Dependency Failure Integration Coverage](./022-dependency-failure-integration-coverage.md) | Partial | Concrete-Postgres attachment worker rollback/retry coverage is in place; SpiceDB, Pub/Sub, and public API storage-failure coverage remain open. Live Postgres interruption testing is excluded. |
