...
**Status:** Todo · **Depends on:** [001](./001-policy-domain-and-persistence.md), [003](./003-policy-document-lifecycle.md) · **Spec:** [spec.md](../spec.md#auditor-portal-read-model)
...
- [ ] Given a non-uploaded current document, when policy data is returned,
