# 004 - MCP Policy Attachment Grants

**Status:** Todo · **Depends on:** [002](./002-mcp-policy-catalog-tools.md), [003](./003-policy-attachment-lifecycle.md) · **Spec:** [spec.md](../spec.md#delegated-browser-management)

**Summary** - Add `manage_policy_attachment` so an authorized MCP connection
...
- [ ] Given tool responses, audit logs, and application logs, when inspected,
  ...
  key.
- [ ] Given evidence attachment grants and sessions, when policy grants ship,
...
- [ ] Add `manage_policy_attachment` request/response schemas and MCP handler.
