...
| 004. [Auth & Identity Audit Logs](./tickets/004-auth-and-identity-audit-logs.md)                         | Todo   | Emit structured user, workspace, membership, and API-token lifecycle logs for the Cloud Logging audit sink.                                                                                         |
