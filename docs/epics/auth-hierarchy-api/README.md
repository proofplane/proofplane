...
| 004. [Auth & Identity Audit Logs](./tickets/004-auth-and-identity-audit-logs.md)                         | Done   | Structured `POST /login`, workspace, membership, and API-token lifecycle application logs shipped.                                                                                                  |
