...
| Ticket | Status | Notes |
| --- | --- | --- |
| 001. [PASETO Keyrings And Token Primitives](./tickets/001-paseto-keyrings-and-token-primitives.md) | Todo | Add `pasetors`, separate key domains, configuration validation, and tested wrappers. |
