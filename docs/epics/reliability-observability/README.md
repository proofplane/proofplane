...
| 005. [MCP And Audit Metrics](./tickets/005-mcp-and-audit-metrics.md) | Todo | Complete instrumentation after those runtimes land. |
...
- **005** follows the MCP Server and Audit Trail foundations.
