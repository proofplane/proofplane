...
| 007. [Evidence Lifecycle Audit Logs](./tickets/007-evidence-lifecycle-audit-logs.md) | Done | Domain audit events for evidence submission, submission, grant, scan, and finalization lifecycle transitions. |
