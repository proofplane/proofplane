...
- [x] Given unavailable attachments, when the model is assembled, then their
...
- [x] Mark attachment download eligibility.
- [x] Add deterministic ordering.
- [x] Add workspace isolation, unavailable-attachment, and object-key exclusion
  tests.

**Notes**

- Spec revised to record the shipped `/auditor-access/portal/data` endpoint and
  archived attachment filtering.
