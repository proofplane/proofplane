...
**Status:** Done · **Depends on:** none · **Spec:** [spec.md](../spec.md#auditor-access-grants)
...
- [x] Emit grant create/revoke audit logs without raw secrets.
- [x] Add integration tests for scope, expiry, revocation, and secret handling.

**Notes**

- Create/revoke audit emission ships through the MCP caller surface in ticket
  002; services return non-secret grant metadata for those logs.
