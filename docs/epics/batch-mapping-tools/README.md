...
| Ticket                                                                             | Status | Notes                                                    |
| ---------------------------------------------------------------------------------- | ------ | -------------------------------------------------------- |
| 001. [Batch Validation and Errors](./tickets/001-batch-validation-and-errors.md)    | Todo   | Shared size/empty/duplicate checks and typed batch errors. |
| 002. [Map Evidence to Controls](./tickets/002-map-evidence-to-controls.md)          | Todo   | One evidence → many controls, with per-pair rationale.     |
