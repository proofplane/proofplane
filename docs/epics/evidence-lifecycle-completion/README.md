...
| 004. [Evidence Submission Context](./tickets/004-evidence-submission-context.md) | Done | Immutable summary and on-demand description fields shipped and verified. |
