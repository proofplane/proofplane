...
| 004. [Browser Upload Page](./tickets/004-browser-upload-page.md) | Done | Serves the minimal page, uploads only the first attachment, and downloads finalized attachments. |
