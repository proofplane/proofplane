...
**Status:** Todo · **Depends on:** 001, 002 · **Spec:** [spec.md](../spec.md#preparation-contract)
...
- [ ] Wire the policy machine-grant service into MCP composition.
- [ ] Enforce `write_controls`, policy concealment, and current-document
  eligibility.
- [ ] Register the tool and route it to the policies guide.
- [ ] Update policy guidance to distinguish human management from trusted-runtime
  upload and explain `get_policy` polling.
- [ ] Add MCP unit and integration tests for schema, success, validation,
