...
Do not retry validation or conflict failures unchanged. Retry transient dependency failures, and request a new attachment URL when only that short-lived grant has expired.
