...
const GET_FOR_UPDATE_SQL: &str = "SELECT id, grant_id, state_digest, nonce_digest, pkce_verifier, expires_at, consumed_at, created_at FROM auditor_auth_transactions WHERE id = $1 FOR UPDATE";
