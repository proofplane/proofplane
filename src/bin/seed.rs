...
async fn main() {
    ...
    println!(
        "Seeded fresh local workspaces, owner membership, local agent connection permissions, demo evidence requests, SOC 2 controls, demo policies, and demo evidence submission"
    );
